...
In this step we deploy a nine node CockroachDB cluster.

## Deploy CockroachDB

**NOTE:** Prior to do this, you must install [a specific variant of yq](https://kislyuk.github.io/yq/).
If you're running on a Mac, you can do it this way:
```
